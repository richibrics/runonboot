# from https://github.com/barneygale/elevate
# Could not use directly elevate as the aim is not to elevate the ull script but only the
# move and delete file commands 
...
class uacHelper():
    ...
    def elevate(command):
        ...
        params = ShellExecuteInfo(
            ...
            hwnd=None,
            lpVerb=b'runas',
            lpFile=sys.executable.encode('cp1252'), # python executable
            lpParameters=command.encode('cp1252'), # command to run
            nShow=0)
